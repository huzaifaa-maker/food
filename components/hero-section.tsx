...
export function HeroSection() {
  return (
    <section className="relative isolate overflow-hidden bg-charcoal text-white" aria-label="Zaiqa Junction hero">
      ...
      <div className="container-pad relative flex min-h-[calc(100svh-3.5rem)] items-center pb-[calc(5.5rem+env(safe-area-inset-bottom))] pt-[calc(5.25rem+env(safe-area-inset-top))] sm:min-h-[680px] lg:min-h-[min(88svh,820px)] lg:pb-16 lg:pt-24">
        <div className="w-full max-w-xl">
          ...
          <p className="mt-4 max-w-md text-[15px] font-medium leading-6 text-white/74 sm:text-base sm:leading-7">
          ...
          <div className="mt-6 grid gap-2.5 sm:flex sm:flex-wrap">
            ...
            <Link
              href="/order"
              className="inline-flex min-h-12 touch-manipulation items-center justify-center gap-2 rounded-2xl border border-white/18 bg-white/10 px-5 py-3 text-sm font-black text-white backdrop-blur transition active:scale-[0.98] hover:bg-white/16 focus:outline-none focus:ring-2 focus:ring-ember focus:ring-offset-2 focus:ring-offset-charcoal sm:w-auto"
            >
              Order Now
