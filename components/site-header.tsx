  ...
  return (
    <header
      className={`fixed inset-x-0 top-0 z-50 transition duration-300 ${
        lightBar
          ? "border-b border-stone-200/70 bg-cream/95 text-charcoal backdrop-blur-md"
      ...
      <div className="container-pad flex min-h-14 items-center justify-between sm:min-h-16">
        <Link href="/" className="flex min-h-11 min-w-0 items-center gap-2.5 sm:gap-3" onClick={() => setOpen(false)}>
          ...
          <span className="min-w-0">
            ...
            <span className="hidden text-[11px] text-stone-500 sm:block">Premium home kitchen</span>
          </span>
        </Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            type="button"
            className="inline-flex h-11 w-11 items-center justify-center rounded-xl border border-stone-300 text-charcoal active:scale-95 lg:hidden"
